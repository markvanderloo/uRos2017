...
\resizebox{\textheight}{!}{%
  ...
  \node[point, right=7mm of tech]       (consistent){Valid};
  ...
  \path (tech.south) edge[arrow, bend right=45] node[below,annote, text width=5em] {Impute and adjust} (consistent.south);
